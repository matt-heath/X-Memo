...
$(document).ready(function () {
	$('.form-update').submit(function(e) {
        ...
        //Sweet alert 2 sample adapted from https://limonte.github.io/sweetalert2/
				swal({
          type: 'success', title: 'Memo Updated!', text: 'Your memo was successfully updated.', timer: 3000, showCancelButton: false, showConfirmButton: false, showCloseButton: true
				}).then(
				  function () {},
        ...
        swal({
          type: 'error', title: 'Error!', text: 'Something went wrong editing the memo.', timer: 3000, showCancelButton: false,showConfirmButton: false, showCloseButton: true}
        ).then(
				  function () {},
				  // handling the promise rejection
				  function (dismiss) {
